export const MAPS_ARRAY = [
  ...
  { id: "rm_arena", name: "Arena", active: false },
  { id: "rm_aso_grasslands", name: "Aso Grasslands", active: false },
  ...
  { id: "rm_kii", name: "Kii", active: true },
  ...
  { id: "rm_okuchichibu", name: "Okuchichibu", active: true },
  { id: "rm_savannah", name: "Savannah", active: true },
  { id: "rm_senjogahara", name: "Senjōgahara", active: true },
  { id: "rm_setonaikai", name: "Setonaikai", active: true },
  { id: "rm_silk_road", name: "Silk Road", active: true },
  { id: "rm_snake_dance", name: "Snake Dance", active: true },
